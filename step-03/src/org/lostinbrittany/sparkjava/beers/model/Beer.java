...
public class Beer {
	 ...
	 * , "id": "AffligemBlond", "img": "beers/img/AffligemBlond.jpg", "name":
	 * "Affligem Blond" }
	 */
	...
	public static List<Beer> getBeers() {
		...
		beer.setImg("beers/img/AffligemDubbel.jpg");
		...
		beer.setImg("beers/img/AffligemTripel.jpg");
		...
		beer.setImg("beers/img/TrappistesRochefort6.jpg");
		...
		beer.setImg("beers/img/TrappistesRochefort8.jpg");
		...
		beer.setImg("beers/img/TrappistesRochefort10.jpg");
		...
		beer.setImg("beers/img/StBernardusPater6.jpg");
		...
		beer.setImg("beers/img/StBernardusTripel.jpg");
		...
		beer.setImg("beers/img/StBernardusAbt12.jpg");
		...
		beer.setImg("beers/img/ChimayRed.jpg");
		...
		beer.setImg("beers/img/ChimayTriple.jpg");
